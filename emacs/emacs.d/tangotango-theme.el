...
(custom-theme-set-faces
 ...
 ;; Personal use for python keyword
 `(py-pseudo-keyword-face ((t (:foreground "tomato"))))
 `(py-builtins-face ((t (:weight bold :foreground "#8ae234"))))
 ;; Personal use for web-mode
 `(web-mode-html-tag-face ((t (:foreground "tomato"))))
 `(web-mode-html-attr-name-face ((t (:foreground "#729fcf"))))
